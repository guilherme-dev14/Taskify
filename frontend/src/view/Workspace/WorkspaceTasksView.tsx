...
export const WorkspaceTasksView: React.FC<WorkspaceTasksViewProps> = ({
  ...
  // Get unique assignees for the avatar group
  ...
  const handleTaskStatusChange = (taskId: string, status: ITask['status']) => {
    ...
    return (
      <div className="flex items-center justify-center h-64">
        <div className="text-center">
          <p className="text-red-600 dark:text-red-400 mb-2">Error loading workspace tasks</p>
          <button 
            onClick={() => refetch()}
        ...
        <div className="flex items-center space-x-4">
          <div className="flex items-center space-x-2">
            ...
            <select
              ...
              onChange={(e) => handleStatusFilter(e.target.value as ITask['status'] || undefined)}
          ...
          <select
            ...
            onChange={(e) => handlePriorityFilter(e.target.value as ITask['priority'] || undefined)}
            className="border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
          >
        ...
        {filteredTasks.length === 0 && (
          <div className="text-center py-12">
            <div className="text-gray-500 dark:text-gray-400">
              {searchQuery ? 'No tasks match your search' : 'No tasks in this workspace yet'}
            </div>
            {!searchQuery && (
